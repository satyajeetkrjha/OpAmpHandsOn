# OpAMP Setup Guide
# Instead of using the Toy Server, I created my own server, but this is to understand the concepts. Do not run it in production.
# Educational purpose Only and code is Generated by ChatGPT
